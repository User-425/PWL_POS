        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-export-history" style="display: none;">
    ...
    <script>
        ...
        $(function () {
            ...
            $('#btn-export-history').on('click', function() {
                if ($.fn.DataTable.isDataTable('#historyTable')) {
                    // Trigger print button from DataTables
                    $('#historyTable_wrapper .buttons-print').trigger('click');
                }
            });
